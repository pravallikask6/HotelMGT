...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@TheOrchid.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 6017222222</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">THE <span>ORCHID</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">THE ORCHID</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our THE ORCHID</h3> 
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Great location, really pleasant and clean rooms. </p>
								<h5>Mythali</h5>
								<p>PUNE</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Lovely hotel with very accomodating staff. </p>
								<h5>Smith</h5>
								<p>BANGALORE</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>The breakfast was outstanding by its quality, and the staff was friendly. </p>
								<h5>Rose</h5>
								<p>DELHI</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>The hotel is very well located and was easy to find,fabulous stay. </p>
								<h5>Rahul</h5>
								<p>CHENNAI</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 6017222222</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@theorchid.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Basveshwara nagar, Ballari, India</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2018 THE ORCHID. All Rights Reserved | Design by <a href="index.php">THE ORCHID</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
